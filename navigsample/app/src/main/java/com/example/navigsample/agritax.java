 ...
 * Use the {@link agritax#newInstance} factory method to
 * create an instance of this fragment.
 */
public class agritax extends Fragment {
     ...
     * @return A new instance of fragment agritax.
     */
    // TODO: Rename and change types and number of parameters
    public static agritax newInstance(String param1, String param2) {
        agritax fragment = new agritax();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v3= inflater.inflate(R.layout.fragment_agritax, container, false);
        final String[] s = {""};
        Button button=(Button) v3.findViewById(R.id.button4);
        Button add=(Button) v3.findViewById(R.id.addat);

        TextView text= v3.findViewById(R.id.textView6);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(agritax.this.getActivity(), writetoagritax.class);
    ...
    public void reada()
    {
        DatabaseReference databaseRef = FirebaseDatabase.getInstance().getReference().child("agri_tax");
